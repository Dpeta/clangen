...
class Name():
    ...
    colour_prefixes = {
        ...
        'SKINBLACK': ['Grey', 'Shade', 'Raven', 'Crow', 'Stone', 'Dark', 'Night',
            'Smoke', 'Shadow', 'Coal', 'Black', 'Black', 'Shade', 'Crow', 'Raven', 'Ebony', 'Dark',
            'Night', 'Shadow', 'Scorch', 'Midnight'],
        'SKINCOFFEE': ['Bean', 'Brown', 'Oak', 'Mouse', 'Dark', 'Shade', 'Russet', 'Stag',
            'Acorn', 'Mud', 'Deer'],
        'SKINCHOCOLATE': ['Bean', 'Brown', 'Oak', 'Mouse', 'Dark', 'Shade', 'Russet', 'Stag',
            'Acorn', 'Mud', 'Deer'],
        'SKINGINGER': ['Pale', 'Gold', 'Golden', 'Yellow', 'Sun', 'Light', 'Lightning', 'Thunder', 'Red', 'Fire', 'Rust', 'Flame', 'Ember', 'Sun',
			'Light', 'Rose','Rowan', 'Fox', 'Tawny', 'Plum', 'Red', 'Red', 'Fire', 'Rust', 'Flame', 'Oak', 'Shade', 'Russet','Rowan', 'Fox'],
        'SKINPALEGREY': ['Grey', 'Shade', 'Raven', 'Crow', 'Stone', 'Dark', 'Night',
            'Smoke', 'Shadow', 'Dusty'],
        'SKINPALECOFFEE': ['Bean', 'Brown', 'Oak', 'Mouse', 'Dark', 'Shade', 'Russet', 'Stag',
            'Acorn', 'Mud', 'Deer'],
        'SKINPALEBROWN': ['Brown', 'Oak', 'Mouse', 'Dark', 'Shade', 'Russet', 'Stag',
            'Acorn', 'Mud', 'Deer', 'Brown', 'Shade', 'Dark', 'Night', 'Russet', 'Rowan', 'Mud'],
        'SKINPALECREAMY': [
            'Sand', 'Yellow', 'Pale', 'Cream', 'Light', 'Milk', 'Fawn',
            'Bone', 'Daisy'
        ],
        'SKINGREY': ['Grey', 'Shade', 'Raven', 'Crow', 'Stone', 'Dark', 'Night',
            'Smoke', 'Shadow',],
        'SKINWHITE': [
            'White', 'White', 'Pale', 'Snow', 'Cloud', 'Milk', 'Hail', 'Frost',
            'Ice', 'Sheep', 'Blizzard', 'Moon', 'Light', 'Bone'
        ],
        'SKINPINK': ['Pale', 'Gold', 'Golden', 'Yellow', 'Sun', 'Light', 'Lightning', 'Thunder', 'Red', 'Fire', 'Rust', 'Flame', 'Ember', 'Sun',
			'Light', 'Rose','Rowan', 'Fox', 'Tawny', 'Plum', 'Red', 'Red', 'Fire', 'Rust', 'Flame', 'Oak', 'Shade', 'Russet','Rowan', 'Fox'],
        'SKINBROWN': ['Brown', 'Oak', 'Mouse', 'Dark', 'Shade', 'Russet', 'Stag',
            'Acorn', 'Mud', 'Deer', 'Brown', 'Shade', 'Dark', 'Night', 'Russet', 'Rowan', 'Mud'],
        }
